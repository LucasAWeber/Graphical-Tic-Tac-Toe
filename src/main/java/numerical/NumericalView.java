...
/**
 * This class works with the GUI of numerical TTT
 * @author Lucas Weber
 * @version 1.0
 */
public class NumericalView extends JPanel {
    ...
    /**
     * This is the constructor for the NumericalView class
    ...
    /**
     * Sets the private var game to be the passed in instance of NumericalGame class
     * @param controller instance of NumericalGame class
     */
    ...
    /**
     * Calls and returns the method getStringToSave from NumericalGame class
     * @return String  returned by NumericalGame method
     */
    ...
    /**
     * Calls the method loadSavedString from NumericalGame class and updates screen
     */
